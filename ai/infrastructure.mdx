...
| **Convex** | 1.18.0 | Real-time Database & Backend Functions |
| **Convex Auth** | 0.0.x | Edge-ready Authentication |
...
- [Database & Permissions](./database.mdx)
- [Bitwise Permission Logic](./bitwise.mdx)
