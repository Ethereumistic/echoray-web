...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@echoray/ui/components/ui/accordion";
import {
  MessageCircle,
  ArrowRight,
  HelpCircle,
...
// Customize your scroll settings here (Desktop only)
...
export function FAQ5() {
  ...
  const scrollToNext = () => {
    ...
    // Mobile: scroll to the mobile CTA section directly
    if (isMobile) {
      const mobileCta = document.getElementById("mobile-cta");
      if (mobileCta) {
        mobileCta.scrollIntoView({ behavior: "smooth", block: "start" });
      }
      return;
    }

    // Desktop: animated scroll with blocking
    const currentScroll = window.scrollY;
    const rootFontSize =
      parseFloat(getComputedStyle(document.documentElement).fontSize) || 16;
    const offsetPx = SCROLL_OFFSET_REM * rootFontSize;
    const targetScroll =
      nextSection.getBoundingClientRect().top + currentScroll - offsetPx;
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto px-4">
            ...
            help you scale your digital presence.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-8 text-base md:text-lg leading-relaxed max-w-md">
                  Skip the research and get direct answers. We’re here to help
                  you navigate your unique requirements and find the perfect
                  path forward.
                </p>
