...
## 🛡 Internal Admin Access (`system.admin`)
...
| User Type | Permission Mask | Bits Granted |
| :--- | :--- | :--- |
| **Staff Admin (tier)** | `MAX_SAFE_INTEGER` | All bits (0-53) |
| **Organization Owner** | `PUBLIC_BITS_MASK` | Bits 0-49 only |
| **Regular Member** | Computed from role | Based on role assignments |

> [!IMPORTANT]
> Organization owners get `PUBLIC_BITS_MASK` (bits 0-49), NOT godmode. Only Staff Admin tier users can access system bits (50+).
