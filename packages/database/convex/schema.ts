...
export default defineSchema({
  ...
  // WebScan Results - Lighthouse audit results
  webscan_results: defineTable({
    scanId: v.string(),
    userId: v.string(),
    url: v.string(),
    status: v.union(
